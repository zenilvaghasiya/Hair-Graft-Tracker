      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        ...
        <div className="grid sm:grid-cols-12 gap-8 py-8 md:py-12 border-t border-gray-200">
          ...
          <div className="sm:col-span-12 lg:col-span-3">
            ...
            <div className="mb-2">
              <div className='text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out'>Email: <a href='info@hairgrafttracker.com'>info@hairgrafttracker.com</a></div>
            </div>
            <div className="mb-2">
              <div className='text-gray-600 hover:text-gray-900 hover:underline transition duration-150 ease-in-out'>Phone: <a href='tel:+19493392336'>+1 (949) 339-2336</a></div>
            </div>
          ...
          {/* 4th block */}
          <div className="sm:col-span-6 md:col-span-4 lg:col-span-5">
          ...
          <div className="sm:col-span-6 md:col-span-4 lg:col-span-4">
            ...
            <p className="text-sm text-gray-600 mb-4">Get the latest  and articles to your inbox every month.</p>
            <form>
        ...
        <div className="md:flex md:items-center md:justify-between py-4 md:py-8 border-t border-gray-200">
          ...
          {/* Copyrights note */}
          <div className="text-sm text-gray-600 mr-4">&copy; HairGraftTracker. All rights reserved.</div>
